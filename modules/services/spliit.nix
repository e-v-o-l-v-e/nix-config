{
  flake.modules.nixos.spliit =
    ...
    in
    {
      config = {
        virtualisation.oci-containers.containers = {
          docker-spliit-db = lib.mkIf cfg.docker.spliit.enable {
            ...
            volumes = [ "${cfg.ssdPath}/spliit/database:/var/lib/postgresql/data" ];
            environment = {
              TZ = "Europe/Paris";
            };
          };
      ...
      options.server.docker.spliit.enable = lib.mkEnableOption "spliit docker container";
    };
}
